...
public class WebDriverUtility {
	...
	public void waitForElementInDOM(WebDriver driver) {
		driver.manage().timeouts().implicitlyWait(IConstants.Implicit_Timeout, TimeUnit.SECONDS);
	}
	...
	public void waitForPage(WebDriver driver , String partialPageURL) {
		WebDriverWait wait = new WebDriverWait(driver, IConstants.Explicit_Timeout);
